...
VALUES ('Иван', 'Смирнов', 'Иванович', '2000-01-01'),
...
VALUES ((SELECT _id
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Александр'
           AND date_of_birth = '2000-06-06'),
        (SELECT _id
         FROM job_title
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Екатерина'
           AND date_of_birth = '1978-04-04'),
        (SELECT _id
         FROM job_title
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Светлана'
           AND date_of_birth = '1984-08-20'),
        (SELECT _id
         FROM job_title
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Владимир'
           AND date_of_birth = '1991-11-03'),
        (SELECT _id
         FROM job_title
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Станислав'
           AND date_of_birth = '2002-04-07'),
        (SELECT _id
         FROM job_title
         WHERE _name = 'Бизнес-аналитик'),
        '2023-02-20', NULL),
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Маргарита'
           AND date_of_birth = '1981-06-10'),
        (SELECT _id
         FROM job_title
         WHERE _name = 'Менеджер проекта'),
        '2022-05-05', NULL),
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Анастасия'
           AND date_of_birth = '1987-10-16'),
        (SELECT _id
         FROM job_title
         WHERE _name = 'Специалист по безопасности'),
        '2021-10-15', NULL),
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Елизавета'
           AND date_of_birth = '1996-08-30'),
        (SELECT _id
         FROM job_title
         WHERE _name = 'Специалист по искусственному интеллекту'),
        '2021-06-25', NULL),
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Григорий'
           AND date_of_birth = '2001-11-02'),
        (SELECT _id
         FROM job_title
         WHERE _name = 'Эксперт по облачным технологиям'),
        '2023-03-01', NULL),
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Александра'
           AND date_of_birth = '2005-05-11'),
        (SELECT _id
         FROM job_title
         WHERE _name = 'DevOps инженер'),
        '2023-02-10', NULL),
       ...
       ((SELECT _id
         FROM employee
         WHERE _name = 'Валентин'
           AND date_of_birth = '1982-07-14'),
...
VALUES ((SELECT _id
        ...
        'Разработка новой функциональности', 'Разработка новой функции для приложения', '2023-01-20', '2023-02-10',
        '2023-02-10',
        (SELECT _id
         FROM task_type
  ...
  (SELECT _id
    ...
    WHERE _name = 'Разработка')),*/
       ...
       ((SELECT _id
         FROM project
         WHERE _name = 'ИПС BOOK'),
        'Разработка новых функциональностей 2', 'Разработка новой функции для приложения', '2023-01-20', '2023-02-10',
        '2023-02-10',
        (SELECT _id
         FROM task_type
         WHERE _name = 'Разработка')),
       ...
       ((SELECT _id
         FROM project
         WHERE _name = 'Проект внедрения системы безопасности'),
        'Тестирование багфиксов', 'Проведение тестирования после внесения исправлений', '2023-03-01', '2023-03-30',
        '2023-03-25',
        (SELECT _id
         FROM task_type
         WHERE _name = 'Тестирование')),
       ...
       ((SELECT _id
        ...
        'Администрирование серверов', 'Обновление операционной системы и настройка безопасности', '2023-01-01',
        '2023-01-20', NULL,
        (SELECT _id
         FROM task_type
       ...
       ((SELECT _id
        ...
        'Анализ рынка конкурентов', 'Проведение исследования для выявления конкурентных преимуществ', '2023-03-20',
        '2023-04-10', NULL,
        (SELECT _id
         FROM task_type
         WHERE _name = 'Администрирование'));
